    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-2">
          <article className="border border-ng-concrete/25 border-l-4 border-l-ng-red bg-ng-white/85 p-8 shadow-sm dark:bg-ng-charcoal dark:shadow-none lg:p-10">
            <h3 className="text-xs font-bold uppercase tracking-[0.1em] text-ng-red">
              {visionMission.vision.title}
            </h3>
            <p className="mt-4 text-base leading-relaxed text-ng-black/78 dark:text-ng-cream/90 sm:text-lg">
        ...
        <div className="mt-10">
          ...
          <ul className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {visionMission.values.map((value) => (
              <li
                key={value}
                className="border border-ng-concrete/25 bg-ng-white/80 px-5 py-4 text-center text-xs font-bold uppercase tracking-[0.08em] text-ng-black/80 shadow-sm dark:bg-ng-charcoal/90 dark:text-ng-cream dark:shadow-none"
              >
                {value}
              </li>
            ))}
